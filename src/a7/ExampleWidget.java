...
public class ExampleWidget extends JPanel implements ActionListener, SpotListener {
	...
	public void spotClicked(Spot s) {
		...
		if (s.isEmpty()) {
			_message.setText(
					player_name + " cleared the spot at " + s.getCoordString() + ". " + next_player_name + " to play.");
		} else {
			if (_game_won) {
				...
				_message.setText(player_name + " found the secret spot at " + s.getCoordString() + ". " + "Score: "
						+ score + ". Game over.");
			} else {
				_message.setText("Spot at " + s.getCoordString() + " is not the spot. Better luck next time. "
